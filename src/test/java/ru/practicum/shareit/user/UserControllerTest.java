...
class UserControllerTest {
    ...
    void getUserWhenInvalidIdThenStatusBadRequest(long id) {
    ...
    @SneakyThrows
    @Test
    void addUserWhenInvalidUserDtoThenStatusBadRequest() {
        userDto.setName("");
    ...
    @ParameterizedTest
    @ValueSource(longs = {0L, -1L, -999L})
    void updateUserWhenInvalidIdThenStatusBadRequest(long id) {
    ...
    @SneakyThrows
    @Test
    void updateUserWhenInvalidUserDtoThenStatusBadRequest() {
        userDto.setEmail("");
    ...
    @ParameterizedTest
    @ValueSource(longs = {0L, -1L, -999L})
    void deleteUserWhenInvalidIdThenStatusBadRequest(long id) {
