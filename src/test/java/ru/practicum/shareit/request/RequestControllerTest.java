...
class RequestControllerTest {
    ...
    @SneakyThrows
    @Test
    void addRequestWhenInvalidDtoThenStatusBadRequest() {
    ...
    void getUserRequestsWhenInvalidIdThenStatusBadRequest(long userId) {
        mvc.perform(get("/requests")
    ...
    @ParameterizedTest
    @ValueSource(longs = {0L, -1L, -999L})
    void getOtherRequestsWhenInvalidIdThenStatusBadRequest(long userId) {
        mvc.perform(get("/requests/all")
                        .header(USER_ID, userId)
                        .param("from", "0")
                        .param("size", "1")
    ...
    void getRequestWhenOneOrBothIdsInvalidThenStatusBadRequest(long userId, int requestId) {
